...
from scripts.v8std_retrieval_rules import RetrievalRules, normalize_text, tokenize
from scripts.v8std_search_features import (
...
# BEGIN V8STD-FORK
from scripts.v8std_knowledge_collections import (
    VALID_COLLECTIONS,
...
class V8StdIndex:
    ...
    # BEGIN V8STD-FORK
    @staticmethod
    def _validate_collections(collections: list[str] | None) -> set[str] | None:
