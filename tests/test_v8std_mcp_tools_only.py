...
SCHEMAS = (
    ("search", ["query"], {
        ...
        "collections": {"anyOf": [{"items": {"type": "string"}, "type": "array"}, {"type": "null"}], "default": None, "title": "Collections"},
...
def assert_tool_catalog(test, rpc):
    ...
    from tests.test_v8std_mcp_server import EXPECTED_TOOL_NAMES
    test.assertEqual([tool["name"] for tool in tools], EXPECTED_TOOL_NAMES)
